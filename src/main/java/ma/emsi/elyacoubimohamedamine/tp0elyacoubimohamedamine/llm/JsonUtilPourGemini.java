...
public class JsonUtilPourGemini implements Serializable {
    ...
    private String creerRequeteJson(String systemRole, String question) {
        // On injecte le rôle dans le texte, pour simuler "system_instruction"
        String prompt = "Rôle : " + systemRole + "\n\n" + question;
    ...
    /**
     * Modifie le JSON de la requête pour ajouter la nouvelle question.
     *
     * @param nouvelleQuestion question posée par l'utilisateur.
     * @return le texte du document JSON de la requête.
     */
    private String ajouteQuestionDansJsonRequete(String nouvelleQuestion) {
        ...
        // La requête sous la forme d'une String avec mise en forme
        this.texteRequeteJson = prettyPrinting(requeteJson);
    ...
    /**
     * Extrait la réponse de l'API et ajoute la réponse à this.jsonRequete pour garder la conversation.
     * @param json le document JSON de la réponse.
     * @return juste le texte de la réponse.
     */
